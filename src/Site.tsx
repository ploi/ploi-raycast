...
const SiteListItem = ({ site, server }: { site: ISite; server: IServer }) => {
  ...
  return (
    <List.Item
      ...
      icon={stateIcon}
      accessories={[
        site.lastDeployAt ? { text: "Last deploy: " + site.lastDeployAt } : {},
        { text: (site.phpVersion ? 'PHP: ' + site.phpVersion : "") },
        { text: stateText, icon: siteStatusState(site).icon}
      ]}
      actions={
        <ActionPanel>
          <ActionPanel.Section>
        ...
        <List.Section title={`Site Commands (${current.domain})`}>
          {site.hasRepository && (
            <List.Item
              ...
              title="Deploy"
              accessories={[
                { text: "This will run the deploy script for your site" }
              ]}
              icon={Icon.Hammer}
              actions={
                <ActionPanel>
          ...
          <List.Item
            ...
            accessories={[
              { text: "This will flush the FastCGI cache" }
            ]}
          ...
          <List.Item
            ...
            icon={Icon.Terminal}
            accessories={[
              { text: `ssh://${site.systemUser}@${server.ipAddress}` }
            ]}
            actions={
              <ActionPanel>
          ...
          <List.Item
            ...
            icon={Icon.Terminal}
            accessories={[
              { text: `sftp://${site.systemUser}@${server.ipAddress}` }
            ]}
            actions={
              <ActionPanel>
                <Action.OpenInBrowser
